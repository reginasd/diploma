...
<?php $topics = getAllTopics();	?>
	<title>Админ | Создание букета</title>
</head>
<body>
	<!-- admin navbar -->
	...
	<div class="container content">
		...
		<div class="action create-post-div">
			<h1 class="page-title">Создать/изменить букет</h1>
			<form method="post" enctype="multipart/form-data" action="<?php echo BASE_URL . 'florist/create_post.php'; ?>" >
				...
				<select name="topic_id">
					<option value="" selected disabled>Выберите подборку</option>
